...
| Stat | Value |
|------|------:|
| 🧩 Problems suffered through | **450+** |
| 📝 Total `.cpp` files (incl. templates) | **465** |
| 💾 Commits of regret | **485** |
...
| 🏯 ZeroJudge | 109 | Taiwan's finest gauntlet of WA verdicts |
| 🇫🇮 CSES | 92 | The classic problem set, one category at a time (see below) |
| 🎓 APCS | 37 | Real exam past papers + simulations |
...
<sub>📈 Auto-updated on every push · last refreshed 2026-07-20 (UTC)</sub>
<!-- STATS:END -->
