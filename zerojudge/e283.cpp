...
void solve() {
    int n; 
    while(cin>>n) {
        vec<vec<int>> v(n, vec<int>(4));
        for(auto &i: v) for(auto &j: i) cin>>j;
        for(auto i: v) {
            if(i == vec<int>{0, 1, 0, 1}) cout<<"A";
            else if(i == vec<int>{0, 1, 1, 1}) cout<<"B";
            else if(i == vec<int>{0, 0, 1, 0}) cout<<"C";
            else if(i == vec<int>{1, 1, 0, 1}) cout<<"D";
            else if(i == vec<int>{1, 0, 0, 0}) cout<<"E";
            else cout<<"F";
        }
        cout<<endl;
    }
