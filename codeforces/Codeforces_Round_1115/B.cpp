...
void solve() {
    ...
    if(abs(num0-num1) == 2) {
        if(num0-num1==2 && (s[0]=='1'||s.back()=='1')) {
            cout<<num1+num0+1<<endl;
            return;
        } else if(num0-num1==-2 && (s[0]=='0'||s.back()=='0')) {
            cout<<num1+num0+1<<endl;
            return;
        }
    } else if(abs(num0-num1) == 3) {
        if(num0-num1==3 && (s[0]=='1'&&s.back()=='1')) {
            cout<<num1+num0+2<<endl;
            return;
        } else if(num0-num1==-3 && (s[0]=='0'&&s.back()=='0')) {
            cout<<num1+num0+2<<endl;
            return;
        }
    }
